...
public class detailOrdersRestaurant extends AppCompatActivity {

    private String TAG = "destailordersRestaurants";
    inteResults mResultCallback = null;
    callRestApi callrestapi;
    ListView listdetailrestaurant;
    String _id;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_orders_restaurant);

        listdetailrestaurant = findViewById(R.id.listdetailrestaurant);
        if (getIntent().getExtras() != null) {
            initVolleyCallback();
            _id = getIntent().getStringExtra("idOrder");
            String url = restApi.server+"services/api/detail-view-order";
        ...
        mResultCallback = new inteResults() {
            ...
            public void notifySuccess(String requestType,JSONObject response) {
                ...
                try {
                    ...
                    listdetailrestaurant.setAdapter(new adapterListDetailOrders(detailOrdersRestaurant.this,itemsMenu));
